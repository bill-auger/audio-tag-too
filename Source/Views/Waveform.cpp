...
//==============================================================================
Waveform::Waveform (AudioFormatManager& format_manager , AudioTransportSource& source , uint8 fps)
...
double Waveform::getZoomFactor() const { return this->zoomFactor ; }
...
void Waveform::mouseWheelMove(const MouseEvent& , const MouseWheelDetails& wheel)
{
  ...
  if (audio_n_secs <= 0.0 || getName() == GUI::UPPER_WAVEFORM_ID) return ;
  ...
  {
    this->zoomFactor      = jlimit(0.0 , 1.0 , (double)(this->zoomFactor - wheel.deltaY)) ;
    double new_scale      = jmax(0.0 , audio_n_secs * this->zoomFactor) ;
...
DEBUG_TRACE_WAVEFORM_SET_VIEWRANGE
  ...
  this->scrollbar->setVisible(this->zoomFactor < 1.0) ;
...
<JUCER_COMPONENT documentType="Component" className="Waveform" componentName=""
                 parentClasses="public Component, public ChangeListener, public ChangeBroadcaster, private ScrollBar::Listener, private Timer"
                 constructorParams="AudioFormatManager&amp; format_manager , AudioTransportSource&amp; source , uint8 fps"
