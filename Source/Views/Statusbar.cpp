...
Statusbar::Statusbar ()
{
  ...
  this->statusLLabel->setColour(Label::textColourId , GUI::HEAD_COLOR  ) ; setStatusL(String()) ;
  this->statusCLabel->setColour(Label::textColourId , GUI::CURSOR_COLOR) ; setStatusC(String()) ;
  this->statusRLabel->setColour(Label::textColourId , GUI::TAIL_COLOR  ) ; setStatusR(String()) ;
